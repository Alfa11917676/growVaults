...
/**
 * @title plastiqueVaultSpawner
 * @author Arnab Ray
 * @notice This contract spawns and initializes eip-1167 minimal proxies that
 * point to existing logic contracts.
 * @notice This contract was modified from Spawner.sol
 * https://github.com/0age/Spawner/blob/master/contracts/Spawner.sol to fit into plastiqueVaultFactory
 */
contract vaultSpawner {
    // fixed salt value because we will only deploy a vault with the same init value once
